...
> **Отправлено на ревью 12.08.2026, 12:29 UTC.** Версия `1.0.0`, билд **4**,
> состояние `WAITING_FOR_REVIEW`, релиз **ручной** (после одобрения выпуск нажимается
> руками). К заявке приложено демо-видео. Всё ниже — история подготовки.
