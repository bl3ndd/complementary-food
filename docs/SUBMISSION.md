...
> **REJECTED 14.08.2026 — Guideline 2.1 Information Needed.** Версия `1.0.0`, билд 4.
> Не баг: ревьюер просит 7 пунктов информации, главное — **демо-видео с живого
> устройства** (наше снято на симуляторе). Что делать — `docs/appstore/REVIEW-REPLY-2.1.md`.
> Review Notes уже перезалиты через API 14.08. Всё ниже — история подготовки.
>
> *Отправлено на ревью 12.08.2026, 12:29 UTC; релиз **ручной**.*
