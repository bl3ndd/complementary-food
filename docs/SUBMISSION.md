...
- [x] Единый медицинский дисклеймер `Disclaimer.medical` — в Профиле → «О приложении» и в описании магазина; зовёт к педиатру (1.4.1). ⚠️ Блокирующий гейт при первом входе убран по продуктовому решению — если ревью прицепится к 1.4.1, вернуть за пять минут.
